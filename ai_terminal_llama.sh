#!/bin/bash
# ai_terminal_llama.sh - Embedded AI Lab using LLaMA
...
while true; do
    ...
    case $choice in
        1)
            echo ""
            echo "Select LLaMA backend:"
            echo "1) PyTorch (full model)"
            echo "2) llama-cpp-python (quantized, CPU)"
            read -p "Enter choice [1-2]: " backend
...
# Change this to your quantized llama cpp model
